...
import 'package:fire_demo/screen/login_signup/login_page.dart';
                  ...
                  itemBuilder: (context, index) {
                    return Padding(
                      ...
                      child: match_details(
                          ...
                          team_2: L[index][1],
                          status: L[index][2],
                          start_time: L[index][3],
                          day_night: L[index][4],
                          match_id: match_id_list[index].toString(),
                          series_name: L[index][5]),
                    );
                  }),
        ),
      ),
    ...
    return InkWell(
      onTap: () {
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => Match_contest(
                    team1: widget.team_1,
                    team2: widget.team_2,
                    match_id: widget.match_id,
                    start_time: widget.start_time.substring(0, 10))));
      },
      child: Container(
        decoration: BoxDecoration(
        ...
        child: Padding(
          ...
          child: Column(
            children: <Widget>[
              ...
              Row(
                ...
                children: <Widget>[
                  CircleAvatar(
                    radius: 30,
                    backgroundImage:
                        AssetImage('images/${widget.team_1.toLowerCase()}.jpg'),
                  ),
                  Text(
                    widget.team_1,
                    style: GoogleFonts.mcLaren(),
                  ...
                  CircleAvatar(
                    radius: 30,
                    backgroundImage:
                        AssetImage('images/${widget.team_2.toLowerCase()}.jpg'),
                  ),
                ],
              ),
              SizedBox(
              ...
              Center(
                child: Text(
                  (widget.day_night == 'night')
                      ? 'Start time : ${widget.start_time.substring(0, 10)} at 7:30 pm'
                      : 'Starts time : ${widget.start_time.substring(0, 10)} at 3:30 pm',
                  style: GoogleFonts.mcLaren(
                    fontSize: 10,
                  ),
                ),
