                    ...
                    child: Row(children: <Widget>[
                      ...
                      Expanded(
                        ...
                        children: <Widget>[
                          ...
                          Text('  VS  ', style: GoogleFonts.mcLaren()),
                          CircleAvatar(
                            radius: 30,
                            backgroundImage: AssetImage(
                                'images/${widget.team2.toLowerCase()}.jpg'),
                          ),
                        ],
                      )),
                      Column(
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return ListTile(
                              ...
                              tileColor: (_color_batsmen[index])
                                  ? Colors.blue
                                  : Colors.white,
                              leading: CircleAvatar(
                                backgroundColor: Colors.white,
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return ListTile(
                              ...
                              tileColor: (_color_allrounder[index])
                                  ? Colors.blue
                                  : Colors.white,
                              leading: CircleAvatar(
                                backgroundColor: Colors.white,
                                radius: 20,
                                backgroundImage:
                                    AssetImage('images/bat_ball.jpg'),
                              ),
                              onTap: () {
                                setState(() {
                                  if (_allrounder_count < 3 &&
                                    ...
                                    _total_players = _total_players + 1;
                                    _allrounder_selected
                                        .add(allrounders[index]);
